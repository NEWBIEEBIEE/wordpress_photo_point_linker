...
*/
    ...
    function widget(){
        ...
        // 拡大と縮小用の原点
        var origin_photo_point_x = 0;
        var origin_photo_point_y = 0;
        ...
        // 図形を指定個所に書く
        function loadShapePositions(textContext, width, height , cvsStyle, posX, posY){
            //alert(posX+','+posY);
            if(testContext){
...
・何歳のころだったかわからない。小学一年生以前のことだと思う
兄弟げんかでナイフを持ち出した。殺すつもりで。何が原因だったのかまるで分らない。母親からは止められた。そのことが原因なんじゃないか？
多分、母は意固地になって俺が精神に問題のない健常者だと思いたかったのではないだろうか？
